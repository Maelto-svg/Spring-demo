...
public class SensorControllerTest {
    ...
    void shouldFindAll() throws Exception {
        Mockito.when(sensorDao.findAll()).thenReturn(List.of(
                FakeEntityBuilder.createSensorEntity(1L, "Temperature room 1", TEMPERATURE, 23.6),
                FakeEntityBuilder.createSensorEntity(2L, "Temperature room 2", TEMPERATURE, 23.6)
        ));
    ...
    void shouldFindById() throws Exception {
        SensorEntity sensorEntity = FakeEntityBuilder.createSensorEntity(1L, "Temperature room 1",TEMPERATURE, 23.6);
